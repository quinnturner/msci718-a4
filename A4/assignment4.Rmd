...
1. Add variable `Talc` <2 - very low to 10 - very high> (Sum of students' drinking habits)
1. Add factor `famrel` <1 - very bad to 5 - excellent>
1. Add factor `freetime` <1 - very low to 5 - very high>
1. Add factor `goout` <1 - very low to 5 - very high>
1. Add factor `health` <1 - very bad to 5 - very good>
