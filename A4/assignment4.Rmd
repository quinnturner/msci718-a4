...
## Contrasts
We desired to see if there was a difference in significance when we segmented the data using Total, just males, and just females when assessing correlation between alcohol consumption and failure.

We found statistically significant results in failures for heavy vs. moderate drinkers with all genders but not when we created two data sets: one for males and one for females. 
