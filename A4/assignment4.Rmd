...
Let's begin by importing and getting a glipse of the dataset.

```{r}
student_mat <- read.csv("student-alcohol-consumption/student-mat.csv")
student_por <- read.csv("student-alcohol-consumption/student-por.csv")
head(student_mat)
head(student_por)
```
...
1. Variable name <variable type>: Reasoning for the transformation
